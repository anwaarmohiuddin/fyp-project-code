...
QosController::ConfigureBorderSwitch (Ptr<const RemoteSwitch> swtch)
{
  ...
  if (m_linkAggregation)
    {
      // Configure Group #9 for aggregating links 1 and 2
      DpctlExecute (swtch, "group-mod cmd=add,type=sel,group=9 "
    ...
    {
      // Configure Group #9 for sending packets only over link 1
      DpctlExecute (swtch, "group-mod cmd=add,type=ind,group=9 "
                    "weight=0,port=any,group=any set_field=ip_src:10.1.1.1"
                    ",set_field=eth_src:00:00:00:00:00:01,output=1");
    }

  // Groups #1-#8 send traffic to internal servers (ports 3 and 4)
  DpctlExecute (swtch, "group-mod cmd=add,type=ind,group=1 "
                "weight=0,port=any,group=any set_field=ip_dst:10.1.1.2,"
                "set_field=eth_dst:00:00:00:00:00:02,set_field=tcp_dst:5000,output=3");
  DpctlExecute (swtch, "group-mod cmd=add,type=ind,group=2 "
                "weight=0,port=any,group=any set_field=ip_dst:10.1.1.3,"
                "set_field=eth_dst:00:00:00:00:00:03,set_field=tcp_dst:5000,output=4");
  DpctlExecute (swtch, "group-mod cmd=add,type=ind,group=3 "
                "weight=0,port=any,group=any set_field=ip_dst:10.1.1.4,"
                "set_field=eth_dst:00:00:00:00:00:04,set_field=tcp_dst:5000,output=5");
  DpctlExecute (swtch, "group-mod cmd=add,type=ind,group=4 "
                "weight=0,port=any,group=any set_field=ip_dst:10.1.1.5,"
                "set_field=eth_dst:00:00:00:00:00:05,set_field=tcp_dst:5000,output=6");
  DpctlExecute (swtch, "group-mod cmd=add,type=ind,group=5 "
                "weight=0,port=any,group=any set_field=ip_dst:10.1.1.6,"
                "set_field=eth_dst:00:00:00:00:00:06,set_field=tcp_dst:5000,output=7");
  DpctlExecute (swtch, "group-mod cmd=add,type=ind,group=6 "
                "weight=0,port=any,group=any set_field=ip_dst:10.1.1.7,"
                "set_field=eth_dst:00:00:00:00:00:07,set_field=tcp_dst:5000,output=8");
  DpctlExecute (swtch, "group-mod cmd=add,type=ind,group=7 "
                "weight=0,port=any,group=any set_field=ip_dst:10.1.1.8,"
                "set_field=eth_dst:00:00:00:00:00:08,set_field=tcp_dst:5000,output=9");
  DpctlExecute (swtch, "group-mod cmd=add,type=ind,group=8 "
                "weight=0,port=any,group=any set_field=ip_dst:10.1.1.9,"
                "set_field=eth_dst:00:00:00:00:00:09,set_field=tcp_dst:5000,output=10");
  ...
  // TCP packets from servers are sent to the external network through group 9
  DpctlExecute (swtch, "flow-mod cmd=add,table=0,prio=700 "
                "in_port=3,eth_type=0x0800,ip_proto=6 apply:group=9");
  DpctlExecute (swtch, "flow-mod cmd=add,table=0,prio=700 "
                "in_port=4,eth_type=0x0800,ip_proto=6 apply:group=9");
}
  ...
  uint32_t xid)
{
  ...
  uint16_t totalServers = 8;
  uint16_t serverNumber = 1 + (connectionCounter % totalServers);
  ...
  if (serverNumber == 1)
        {
          ...
          std::ostringstream flowCmd1;
          flowCmd1 << "flow-mod cmd=add,table=0,prio=1000 eth_type=0x0800,ip_proto=6"
            << ",ip_src=" << srcIp
            << "ip_dst=" << m_serverIpAddress
            << ",tcp_dst=" << m_serverTcpPort
            << ",tcp_src=" << srcPort;
	  	  	//  << " apply:set_field=ip_dst:10.1.1.2, apply:set_field=eth_dst:00:00:00:00:00:02, apply:output=3";
	  	  	  DpctlExecute (swtch, flowCmd1.str ());

	  	  	std::ostringstream flowCmd2;
	  	  	flowCmd2 << "flow-mod cmd=add,table=0,prio=900 in_port=5,eth_type=0x800,ip_proto=6,ip_src=10.1.1.2,ip_dst="<< srcIp
	  	  	  << " apply:set_field=ip_src:10.1.1.1"
	  	  	  << ", apply:set_field=eth_src:00:00:00:00:00:01"
            << ", apply:set_field=tcp_src:5000"
	  	  	  << ", apply:output="<<inPort;
          ...
          flowCmd1 << "flow-mod cmd=add,table=0,prio=1000 eth_type=0x0800,ip_proto=6"
            ...
            << ",tcp_dst=" << m_serverTcpPort
            << ",tcp_src=" << srcPort;
	  	  	//  << " apply:set_field=ip_dst:10.1.1.3, apply:set_field=eth_dst:00:00:00:00:00:03, apply:output=4";
	  	  	  DpctlExecute (swtch, flowCmd1.str ());

	  	  	std::ostringstream flowCmd2;
	  	  	flowCmd2 << "flow-mod cmd=add,table=0,prio=900 in_port=6,eth_type=0x800,ip_proto=6,ip_src=10.1.1.3,ip_dst="<< srcIp
	  	  	  << " apply:set_field=ip_src:10.1.1.1"
	  	  	  << ", apply:set_field=eth_src:00:00:00:00:00:01"
            << ", apply:set_field=tcp_src:5000"
	  	  	  << ", apply:output="<<inPort;
          ...
          flowCmd1 << "flow-mod cmd=add,table=0,prio=1000 eth_type=0x0800,ip_proto=6"
            ...
            << ",tcp_dst=" << m_serverTcpPort
            << ",tcp_src=" << srcPort;
	  	  	//  << " apply:set_field=ip_dst:10.1.1.4, apply:set_field=eth_dst:00:00:00:00:00:04, apply:output=5";
	  	  	  DpctlExecute (swtch, flowCmd1.str ());

	  	 	std::ostringstream flowCmd2;
	  	  	flowCmd2 << "flow-mod cmd=add,table=0,prio=900 in_port=7,eth_type=0x800,ip_proto=6,ip_src=10.1.1.4,ip_dst="<< srcIp
	  	  	  << " apply:set_field=ip_src:10.1.1.1"
	  	  	  << ", apply:set_field=eth_src:00:00:00:00:00:01"
            << ", apply:set_field=tcp_src:5000"
	  	  	  << ", apply:output="<<inPort;
          ...
          flowCmd1 << "flow-mod cmd=add,table=0,prio=1000 eth_type=0x0800,ip_proto=6"
            ...
            << ",tcp_dst=" << m_serverTcpPort
            << ",tcp_src=" << srcPort;
	  	  	//  << " apply:set_field=ip_dst:10.1.1.5, apply:set_field=eth_dst:00:00:00:00:00:05, apply:output=6";
	  	  	  DpctlExecute (swtch, flowCmd1.str ());

	  	  	std::ostringstream flowCmd2;
	  	  	flowCmd2 << "flow-mod cmd=add,table=0,prio=900 in_port=8,eth_type=0x800,ip_proto=6,ip_src=10.1.1.5,ip_dst="<< srcIp
	  	  	  << " apply:set_field=ip_src:10.1.1.1"
	  	  	  << ", apply:set_field=eth_src:00:00:00:00:00:01"
            << ", apply:set_field=tcp_src:5000"
	  	  	  << ", apply:output="<<inPort;
        ...
        else if (serverNumber == 5)
        {
          ...
          flowCmd1 << "flow-mod cmd=add,table=0,prio=1000 eth_type=0x0800,ip_proto=6"
            ...
            << ",tcp_dst=" << m_serverTcpPort
            << ",tcp_src=" << srcPort;
	  	  	//  << " apply:set_field=ip_dst:10.1.1.6, apply:set_field=eth_dst:00:00:00:00:00:06, apply:output=7";
	  	  	  DpctlExecute (swtch, flowCmd1.str ());

	    	std::ostringstream flowCmd2;
	  	  	flowCmd2 << "flow-mod cmd=add,table=0,prio=900 in_port=9,eth_type=0x800,ip_proto=6,ip_src=10.1.1.6,ip_dst="<< srcIp
	  	  	  << " apply:set_field=ip_src:10.1.1.1"
	  	  	  << ", apply:set_field=eth_src:00:00:00:00:00:01"
            << ", apply:set_field=tcp_src:5000"
	  	  	  << ", apply:output="<<inPort;
          ...
          flowCmd1 << "flow-mod cmd=add,table=0,prio=1000 eth_type=0x0800,ip_proto=6"
            ...
            << ",tcp_dst=" << m_serverTcpPort
            << ",tcp_src=" << srcPort;
	  	  	// << " apply:set_field=ip_dst:10.1.1.7, apply:set_field=eth_dst:00:00:00:00:00:07, apply:output=8";
	  	  	  DpctlExecute (swtch, flowCmd1.str ());

	 	  	std::ostringstream flowCmd2;
	  	  	flowCmd2 << "flow-mod cmd=add,table=0,prio=900 in_port=10,eth_type=0x800,ip_proto=6,ip_src=10.1.1.7,ip_dst="<< srcIp
	  	  	  << " apply:set_field=ip_src:10.1.1.1"
	  	  	  << ", apply:set_field=eth_src:00:00:00:00:00:01"
            << ", apply:set_field=tcp_src:5000"
	  	  	  << ", apply:output="<<inPort;
          ...
          flowCmd1 << "flow-mod cmd=add,table=0,prio=1000 eth_type=0x0800,ip_proto=6"
            ...
            << ",tcp_dst=" << m_serverTcpPort
            << ",tcp_src=" << srcPort;
	  	  	//  << " apply:set_field=ip_dst:10.1.1.8, apply:set_field=eth_dst:00:00:00:00:00:08, apply:output=9";
	  	  	  DpctlExecute (swtch, flowCmd1.str ());

	  	  	std::ostringstream flowCmd2;
	  	  	flowCmd2 << "flow-mod cmd=add,table=0,prio=900 in_port=11,eth_type=0x800,ip_proto=6,ip_src=10.1.1.8,ip_dst="<< srcIp
	  	  	  << " apply:set_field=ip_src:10.1.1.1"
	  	  	  << ", apply:set_field=eth_src:00:00:00:00:00:01"
            << ", apply:set_field=tcp_src:5000"
	  	  	  << ", apply:output="<<inPort;
          ...
          flowCmd1 << "flow-mod cmd=add,table=0,prio=1000 eth_type=0x0800,ip_proto=6"
            ...
            << ",tcp_dst=" << m_serverTcpPort
            << ",tcp_src=" << srcPort;
	  	  	// << " apply:set_field=ip_dst:10.1.1.9, apply:set_field=eth_dst:00:00:00:00:00:09, apply:output=10";
	  	  	  DpctlExecute (swtch, flowCmd1.str ());

	  	  	std::ostringstream flowCmd2;
	  	  	flowCmd2 << "flow-mod cmd=add,table=0,prio=900 in_port=12,eth_type=0x800,ip_proto=6,ip_src=10.1.1.9,ip_dst="<< srcIp
	  	  	  << " apply:set_field=ip_src:10.1.1.1"
	  	  	  << ", apply:set_field=eth_src:00:00:00:00:00:01"
            << ", apply:set_field=tcp_src:5000"
	  	  	  << ", apply:output="<<inPort;
